...
static Color primary()    { return Color::RGB(100, 149, 237); }  // Cornflower blue
static Color accent()     { return Color::RGB(72, 209, 204);  }  // Medium turquoise
static Color success_c()  { return Color::RGB(50, 205, 50);   }  // Lime green
static Color error_c()    { return Color::RGB(255, 99, 71);   }  // Tomato
static Color dim()        { return Color::RGB(128, 128, 128);  }  // Gray
static Color surface()    { return Color::RGB(30, 30, 46);     }  // Dark surface
